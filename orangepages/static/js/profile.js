...
function openPosts() {
	...
	$("#hidden-posts").addClass("d-none");
	$("#posts-tab").addClass("profile-active");
	$("#details-tab").removeClass("profile-active");
}

function openDetails() {
	$("#hidden-posts").removeClass("d-none");
	$("#posts").addClass("d-none");
	$("#details-tab").addClass("profile-active");
	$("#posts-tab").removeClass("profile-active");
}
...
$(document).ready(function() {
    ...
    $("#school").change(function() {
        var val = $(this).val();
        if (val == "AB") {
            $("#major").html("<option value='aas'>African American Studies</option>\
                             ...
                             <option value='cmp'>Comparative Literature</option>\
                             ...
                             <option value='fre'>French and Italian</option>\
                             ...
                             <option value='neu'>Neuroscience</option>\
                             ...
                             <option value='spa'>Spanish and Portuguese</option>\
